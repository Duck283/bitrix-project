...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180"
          href="<?= SITE_TEMPLATE_PATH ?>/favicon/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32"
          href="<?= SITE_TEMPLATE_PATH ?>/favicon/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16"
          href="<?= SITE_TEMPLATE_PATH ?>/favicon/favicon-16x16.png">
</head>
...
<div class="main-wrapper" id="app">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="/services/">Динозавры</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/news/">Блог</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/contacts/">Приют динозавриков</a>
                    </li>

                    <li class="nav-item">
                        <a class="btn btn-secondary" href="/auth.php">Войти</a>
                        <a class="btn btn-outline-secondary" href="/auth.php?register=yes">Зарегистрироваться</a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownBlog">
                            <a class="dropdown-item" href="/about/">Личный кабинет</a>
    ...
    <main class="site-content<?= ($APPLICATION->GetCurPage(false) === '/' ? ' site-content-home' : '') ?>">
