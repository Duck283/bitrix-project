...
// JS
$asset->addJs($APPLICATION->GetTemplatePath('/vendor/jquery/jquery.js'));
$asset->addJs($APPLICATION->GetTemplatePath('/vendor/bootstrap/js/bootstrap.bundle.js'));
$asset->addJs($APPLICATION->GetTemplatePath('/js/script.js'));
?>
<!doctype html>
<html lang="ru">
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180"
          href="<?= $APPLICATION->GetTemplatePath('/favicon/apple-touch-icon.png') ?>">
    <link rel="icon" type="image/png" sizes="32x32"
          href="<?= $APPLICATION->GetTemplatePath('/favicon/favicon-32x32.png') ?>">
    <link rel="icon" type="image/png" sizes="16x16"
          href="<?= $APPLICATION->GetTemplatePath('/favicon/favicon-16x16.png') ?>">
</head>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownBlog">
                            <a class="dropdown-item" href="personal.html">Личный кабинет</a>
