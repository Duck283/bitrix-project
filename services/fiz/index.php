        ...
        <div class="row">
            <div class="col-lg-6 portfolio-item">
                <div class="card h-100">
                    <a href="/services/fiz/cards.php"><img class="card-img-top" src="<?= SITE_TEMPLATE_PATH ?>/images/dinosaurs/tirannozavr.jpg" alt="Тираннозавр"></a>
                    <div class="card-body">
                        <h4 class="card-title">
                            <a href="/services/fiz/cards.php">Тираннозавр</a>
                        </h4>
            ...
            <div class="col-lg-6 portfolio-item">
                <div class="card h-100">
                    <a href="/services/fiz/cards.php"><img class="card-img-top" src="<?= SITE_TEMPLATE_PATH ?>/images/dinosaurs/velociraptor_p.jpg" alt="Велоцираптор"></a>
                    <div class="card-body">
                        <h4 class="card-title">
                            <a href="/services/fiz/cards.php">Велоцираптор</a>
                        </h4>
            ...
            <div class="col-lg-6 portfolio-item">
                <div class="card h-100">
                    <a href="/services/fiz/cards.php"><img class="card-img-top" src="<?= SITE_TEMPLATE_PATH ?>/images/dinosaurs/triceratops.jpg" alt="Трицератопс"></a>
                    <div class="card-body">
                        <h4 class="card-title">
                            <a href="/services/fiz/cards.php">Трицератопс</a>
                        </h4>
            ...
            <div class="col-lg-6 portfolio-item">
                <div class="card h-100">
                    <a href="/services/fiz/cards.php"><img class="card-img-top" src="<?= SITE_TEMPLATE_PATH ?>/images/dinosaurs/brontozavr.jpg" alt="Бронтозавр"></a>
                    <div class="card-body">
                        <h4 class="card-title">
                            <a href="/services/fiz/cards.php">Бронтозавр</a>
                        </h4>
            ...
            <div class="col-lg-6 portfolio-item">
                <div class="card h-100">
                    <a href="/services/fiz/cards.php"><img class="card-img-top" src="<?= SITE_TEMPLATE_PATH ?>/images/dinosaurs/pterodaktil.jpg" alt="Птеродактиль"></a>
                    <div class="card-body">
                        <h4 class="card-title">
                            <a href="/services/fiz/cards.php">Птеродактиль</a>
                        </h4>
            ...
            <div class="col-lg-6 portfolio-item">
                <div class="card h-100">
                    <a href="/services/fiz/cards.php"><img class="card-img-top" src="<?= SITE_TEMPLATE_PATH ?>/images/dinosaurs/parazavrolofus.jpg" alt="Паразавролофус"></a>
                    <div class="card-body">
                        <h4 class="card-title">
                            <a href="/services/fiz/cards.php">Паразавролофус</a>
                        </h4>
